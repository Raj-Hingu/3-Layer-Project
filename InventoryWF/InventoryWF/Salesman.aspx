...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
 ...
 <!--  <div class="form-group row">
    ...
    <asp:Label ID="EnterSalesman" runat="server" Text="Enter SalesmanID"></asp:Label>
            <asp:TextBox class="form-control" ID="txtEnterSalesman" runat="server" placeholder="Enter Salesman" ></asp:TextBox>
